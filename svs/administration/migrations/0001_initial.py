    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpf', models.CharField(max_length=14, unique=True, validators=[django.core.validators.RegexValidator('^\\d{3}\\.\\d{3}\\.\\d{3}-\\d{2}$', message='CPF inválido. Formato esperado: 000.000.000-00')])),
                ('photo', models.ImageField(blank=True, null=True, upload_to='documentos/')),
